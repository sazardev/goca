---
layout: doc
title: v1.17.2 Release Notes
titleTemplate: Releases | Goca Blog
description: "Goca v1.17.2: SQLite as default database for zero-config Go projects, MongoDB GORM import fix, and improved developer experience for Clean Architecture code generation."
head:
  - - meta
    - name: keywords
      content: 'goca 1.17.2, sqlite default database, mongodb golang, goca release, go clean architecture, codegen bug fix, gorm, mongodb fix, zero config'
---
...
# v1.17.2 - Database Defaults and MongoDB Fixes
...
**MongoDB projects created before v1.17.2:**
...
- [GitHub Release](https://github.com/sazardev/goca/releases/tag/v1.17.2)
...
<div style="display: flex; justify-content: space-between; margin-top: 2rem;">
  <div>
    <strong>Previous:</strong> <a href="/goca/blog/releases/v1-17-1">v1.17.1</a>
  </div>
</div>

[View on GitHub](https://github.com/sazardev/goca/releases/tag/v1.17.2) • [Download](https://github.com/sazardev/goca/releases/tag/v1.17.2) • [Report Issue](https://github.com/sazardev/goca/issues)
