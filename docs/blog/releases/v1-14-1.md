...
description: "Goca v1.14.1: test suite fixes — Windows path handling, t.TempDir() migration, working directory management, and Go module dependency corrections for reliable builds."
head:
  - - meta
    - name: keywords
      content: 'goca 1.14.1, goca release notes, golang test suite, t.TempDir, go clean architecture, code generator, bug fix, windows path handling, go module'
---
