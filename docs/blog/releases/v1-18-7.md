...
description: "Goca v1.18.7 bug fix: --dry-run, --force, and --backup safety flags correctly wired through all 12 file-generating commands via SafetyManager in this Go code generator."
head:
  - - meta
    - name: keywords
      content: 'goca 1.18.7, dry-run, force, backup, safety flags, SafetyManager, go clean architecture, code generator, file safety, bug fix'
---
...
- [Safety & Dependency Management](/features/safety-and-dependencies) — full SafetyManager documentation
- [v1.18.0 Release Notes](/blog/releases/v1-18-0) — initial SafetyManager and UIRenderer introduction
