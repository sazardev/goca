...
- [Safety & Dependency Management](/goca/features/safety-and-dependencies) — `--dry-run`, `--force`, `--backup` documentation
- [v1.18.7 Release Notes](/goca/blog/releases/v1-18-7) — safety flags universally applied to all commands
- [v1.18.0 Release Notes](/goca/blog/releases/v1-18-0) — UIRenderer and initial SafetyManager introduction
