...
description: "Goca v1.18.2: goca doctor project health checks, goca upgrade config management, --quiet and --verbose global flags, and improved dry-run preview table for Go Clean Architecture."
head:
  - - meta
    - name: keywords
      content: 'goca 1.18.2, goca doctor, goca upgrade, dry-run, quiet mode, verbose, go clean architecture, health checks, configuration management, codegen'
---
