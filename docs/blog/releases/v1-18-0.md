...
description: "Goca v1.18.0: CLI UX overhaul — styled ANSI output, interactive goca init wizard, --no-color and --no-interactive global flags, and unified rendering across all Go codegen commands."
head:
  - - meta
    - name: keywords
      content: 'goca 1.18.0, goca CLI, interactive wizard, ANSI output, no-color flag, go clean architecture, terminal output, code generator, goca init, UX'
---
