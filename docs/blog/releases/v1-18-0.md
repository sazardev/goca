...
description: Complete CLI output rendering system, interactive initialization wizard, global flags for color and interactivity control, and unified English output layer.
---
