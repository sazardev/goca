...
description: "Goca v1.22.0: goca analyze (30-rule static self-analysis), Redis cache decorator, GitHub Actions CI gen, composable HTTP middleware, and MCP server for GitHub Copilot and Claude AI."
head:
  - - meta
    - name: keywords
      content: 'goca 1.22.0, goca analyze, static analysis, clean architecture rules, redis cache decorator, github actions CI, http middleware, MCP server, github copilot, claude desktop, AI coding assistant, golang code generator'
---
...
- [`goca analyze` command reference](/commands/analyze)
- [`goca ci` command reference](/commands/ci)
- [`goca middleware` command reference](/commands/middleware)
- [`goca mcp-server` command reference](/commands/mcp-server)
