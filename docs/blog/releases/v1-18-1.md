...
description: "Goca v1.18.1: bug fixes for goca init interactive wizard no-argument launch and goca version showing correct build info via runtime/debug.ReadBuildInfo in Go projects."
head:
  - - meta
    - name: keywords
      content: 'goca 1.18.1, goca init wizard, goca version, go clean architecture, bug fix, runtime debug, ReadBuildInfo, interactive init, codegen'
---
...
- [v1.18.0 Release Notes](/blog/releases/v1-18-0) — UIRenderer, interactive wizard, and global flags introduction
- [v1.18.2 Release Notes](/blog/releases/v1-18-2) — `goca doctor`, `goca upgrade`, `--quiet`/`--verbose` flags
