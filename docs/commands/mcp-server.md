...
| `goca_ci` | `goca ci` | Generate GitHub Actions CI/CD pipeline workflows (test, build, deploy) |
| `goca_middleware` | `goca middleware <Name>` | Generate composable HTTP middleware package (7 types) |
